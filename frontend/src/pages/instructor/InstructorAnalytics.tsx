  ...
  const fetchAnalytics = async () => {
    try {
      const response = await apiConnector({
        method: "GET",
        url: analyticsEndpoints.GET_INSTRUCTOR_ANALYTICS_API
      });
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="animate-pulse space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl h-96"></div>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Track your performance and course metrics
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl shadow-lg p-6 text-white">
            ...
            <p className="text-xs opacity-75 mt-2">From all courses</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-lg p-6 text-white">
            ...
            <p className="text-xs opacity-75 mt-2">Enrolled across courses</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl shadow-lg p-6 text-white">
            ...
            <p className="text-3xl font-bold">{analytics?.averageRating.toFixed(1)} / 5.0</p>
